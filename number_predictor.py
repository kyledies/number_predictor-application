...
""")
    ...
    st.header("Information om applikationen", divider=True)

    st.write("""
                Denna applikation är utvecklad för att möjliggöra interaktiv maskininlärning där användare kan rita siffror 
                och få dem klassificerade av en tränad modell. Genom en enkel och intuitiv gränssnitt kan användaren testa sin
                handstil mot en AI-modell baserad på MNIST-datasetet.
             
                Förutom att analysera handritade siffror erbjuder applikationen statistik över modellens träffsäkerhet och utveckling över tid. 
                Användare kan enkelt återställa statistik och justera parametrar för att optimera sina resultat.
                Syftet med applikationen är att ge en lärorik och engagerande upplevelse inom Artificiell Intelligens.
             """)
